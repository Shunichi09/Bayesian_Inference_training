...
class VariantSampler():
    ...
    def estimate_val(self):
        ...
        mean_1 = self.est_mean[0] - 1. / self.est_cov[0, 0] * self.est_cov[0, 1] * (self.est_mean[0] - self.est_mean[1])
        mean_2 = self.est_mean[1] - 1. / self.est_cov[1, 1] * self.est_cov[1, 0] * (self.est_mean[1] - self.est_mean[0])

        self.est_mean = np.array[]

        self.est_mean = copy.deepcopy()
